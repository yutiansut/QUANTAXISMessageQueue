...
#ifndef PROTOBUF_future_2eproto__INCLUDED
#define PROTOBUF_future_2eproto__INCLUDED
...
class future_min : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:future.future_min) */ {
 public:
  future_min();
  virtual ~future_min();
  ...
  inline future_min* New() const { return New(NULL); }

  future_min* New(::google::protobuf::Arena* arena) const;
  ...
  void InternalSwap(future_min* other);
  private:
  ...
  bool has_barendtime() const;
  void clear_barendtime();
  static const int kBarendtimeFieldNumber = 7;
  const ::std::string& barendtime() const;
  void set_barendtime(const ::std::string& value);
  void set_barendtime(const char* value);
  void set_barendtime(const char* value, size_t size);
  ::std::string* mutable_barendtime();
  ::std::string* release_barendtime();
  void set_allocated_barendtime(::std::string* barendtime);
 ...
 private:
  ...
  float volume_;
  float turnover_;
  ::google::protobuf::internal::ArenaStringPtr barendtime_;
  ::google::protobuf::internal::ArenaStringPtr day_;
  friend void  protobuf_AddDesc_future_2eproto();
  friend void protobuf_AssignDesc_future_2eproto();
  friend void protobuf_ShutdownFile_future_2eproto();
...
#endif  // PROTOBUF_future_2eproto__INCLUDED
